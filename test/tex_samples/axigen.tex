...
(\ref{presslaw})). This multifluid model presents a supplementary
...
acceptable numerical results is not detailed. Karni, in
...
conservative. Hence, the resulting scheme allows slight mass
...
contact in the Riemann solution between two cells. The
Abgrall-Saurel reasoning is only valid for a multifluid flow where
